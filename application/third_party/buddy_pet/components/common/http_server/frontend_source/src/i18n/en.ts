export const en = {
  ...
  setupIntro:
    'Connect Wi-Fi first, then bind the device with WeChat. Other features can be configured later from settings.',
  setupStepLabel: 'Step {index}',
  setupStepWifi: 'Connect Wi-Fi',
  setupStepWifiDesc:
    'Enter the router Wi-Fi SSID and password. The device will try to connect immediately while keeping this setup page available.',
  setupStepWechat: 'Bind WeChat',
  setupStepWechatDesc:
    'The WeChat QR code appears on both the web page and device screen. Scan and confirm to save binding automatically.',
  ...
  setupWifiConnecting: 'Wi-Fi config saved. The device is trying to connect.',
  setupWifiApplyHint:
    'After saving, the device starts connecting to Wi-Fi while keeping the setup hotspot available.',
  setupWechatAutoSaveHint: 'Scan the QR code with WeChat. Binding is saved automatically after confirmation.',
  setupSaving: 'Saving...',
  setupBack: 'Back',
  setupSkip: 'Skip',
