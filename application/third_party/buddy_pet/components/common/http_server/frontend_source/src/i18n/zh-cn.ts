...
export const zhCn: Dict = {
  ...
  setupEyebrow: '初次使用向导',
  setupTitle: '完成设备首次配置',
  setupIntro: '先连接 Wi-Fi，再用微信扫码绑定设备。其他能力可稍后在设置页补全。',
  setupStepLabel: '步骤 {index}',
  setupStepWifi: '连接 Wi-Fi',
  setupStepWifiDesc: '输入路由器 Wi-Fi 名称和密码，设备会立即尝试联网并保持当前配网页面可用。',
  setupStepWechat: '绑定微信',
  setupStepWechatDesc: '网页和设备屏幕会同时显示微信二维码，扫码确认后自动保存绑定信息。',
  setupStepLlm: '配置 LLM',
  ...
  setupWifiConnecting: 'Wi-Fi 配置已保存，正在尝试连接。',
  setupWifiApplyHint: '点击保存后设备会开始连接 Wi-Fi；当前网页会继续通过设备热点保持可访问。',
  setupWechatAutoSaveHint: '请使用微信扫描二维码，绑定成功后会自动保存。',
  setupSaving: '正在保存...',
  setupBack: '上一步',
  setupSkip: '跳过',
