export const en = {
  ...
  fileLuaRun: 'Run',
  fileLuaStop: 'Stop',
  fileLuaRunStarted: 'Script started',
  fileLuaRunDone: 'Script completed',
  fileLuaRunStopped: 'Script stopped',
  fileLuaRunStopRequested: 'Stop requested',
  fileLuaAlreadyRunning: 'A script is already running',
